...
## 一键脚本
```
apt install curl -y && bash <(curl -fsSL https://raw.githubusercontent.com/pjy02/vps-setup/refs/heads/main/install.sh)
```
运行一键脚本后依次配置：
